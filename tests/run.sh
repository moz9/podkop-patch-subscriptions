...
sh "$test_dir/test_official_upgrade_transaction.sh"
sh "$test_dir/test_release_metadata_sync.sh"
sh "$test_dir/test_ui_regressions.sh"
sh "$test_dir/test_fakeip_lmo_translations.sh"
sh "$test_dir/test_luci_versioned_assets.sh"
sh "$test_dir/test_installer_rollback_guard.sh"
sh "$test_dir/test_dns_default_migration.sh"
sh "$test_dir/test_dns_primary_policy.sh"
sh "$test_dir/test_dns_google_play_guard.sh"
sh "$test_dir/test_dns_apply_rollback_truth.sh"
sh "$test_dir/test_fakeip_router_truth.sh"
